<div id="up" class="home">
    ...
    <span class="home__mensaje <?php echo $clase??''; ?>"> <?php echo $mensaje??''; ?></span>
    <a class="home__aboutme" href="#aboutme"><i class="fa-solid fa-chevron-down"></i></a>

    <svg x="0px" y="0px" viewBox="0 186.5 1920 113.5">
        <polygon points="0,300 655.167,210.5 1432.5,300 1920,250 1920,300 "></polygon>
    </svg>
    ...
    <div class="aboutme__contenedor">
        ...
        <div class="mywork__technology">
            ...
            <div class="mywork__listado slider swiper">
                ...
                <div class="swiper-button-next"></div>  <!-- botn siguiente -->
                <div class="swiper-button-prev"></div> <!-- botn atras -->
            </div>
        </div>
    </div>
    <svg x="0px" y="0px" viewBox="0 186.5 1920 113.5">
...
<div class="contact">
    <div class="contact__contenedor">
        ...
        <div class="contact__all">
            ...
            <div class="contact__info">
                <div class="contacto"><img src="build/img/email.png" alt="email"></div>
                <h3>Email</h3>
                <p>julianlink123@hotmail.com</p>
                <p>julianithox1@gmail.com</p>
            </div>
            <div class="contact__info">
...
<div class="flechaup">
    <a href="#up"><i class="fa-solid fa-arrow-up-long"></i></a>
</div>
